...
- [x] The spec's response table needs amending to match the full `clasificarRespuesta` mapping above. — Done: `specs/invoice-batch-publication/spec.md`'s table and its three response-code scenarios now cover 2xx/409, 422/429/5xx/network/timeout/signed-URL failures, and 401/403/other-4xx, matching the implementation.
