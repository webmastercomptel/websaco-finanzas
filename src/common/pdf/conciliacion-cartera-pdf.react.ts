...
/**
 * React-pdf port of `generarPdfConciliacionCartera` (see
 * `conciliacion-cartera-pdf.ts`, kept unchanged and still wired into the
 * controller). Same ten-concept table + calculated-vs-real balance
 * comparison + anticipos-pendientes table, different renderer underneath.
 */
export async function generarPdfConciliacionCarteraReactPdf(
